...
// Copies pixels from a captured AHardwareBuffer into a CPU-writable destination AHB.
// This is intentionally a CPU-only capture/upload path: the Vulkan queue is not used
// for real-frame movement; Vulkan is reserved for the frame-generation workload and
// the final presentation path. AHardwareBuffer_lock/unlock provides the required
// producer/consumer cache synchronization.
